...
def get_random_match(teams):
    ...
    teams_with_similar_rating = [d for d in teams if d['rating'] in [team_1["rating"],team_1["rating"]-0.5,team_1["rating"]+0.5]]
    ...
    print(team_1["team"] +" ("+str(team_1["rating"])+")" +" ("+team_1["league"]+")" +" vs "+team_2["team"]+" ("+str(team_2["rating"])+")" +" ("+team_2["league"]+")")
